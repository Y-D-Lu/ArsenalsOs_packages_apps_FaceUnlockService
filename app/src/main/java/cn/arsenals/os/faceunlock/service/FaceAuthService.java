package cn.arsenals.os.faceunlock.service;
...
import cn.arsenals.os.faceunlock.AppConstants;
import cn.arsenals.os.faceunlock.R;
import cn.arsenals.os.faceunlock.camera.CameraFaceAuthController;
import cn.arsenals.os.faceunlock.camera.CameraFaceEnrollController;
import cn.arsenals.os.faceunlock.camera.CameraUtil;
import cn.arsenals.os.faceunlock.util.NotificationUtils;
...
import cn.arsenals.os.faceunlock.vendor.impl.VendorFaceManagerImpl;

import java.util.Random;

@SuppressWarnings("SynchronizeOnNonFinalField")
public class FaceAuthService extends Service {
    private static final String ALARM_FAIL_TIMEOUT_LOCKOUT = "cn.arsenals.os.faceunlock.ACTION_LOCKOUT_RESET";
    private static final String ALARM_TIMEOUT_FREEZED = "cn.arsenals.os.faceunlock.freezedtimeout";
